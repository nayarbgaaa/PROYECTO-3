...
class ProductosModel extends Model
{
    ...
    protected $allowedFields = ['codigo', 'nombre', 'precio_venta', 'precio_compra', 'ventas', 'existencias', 'stock_minimo', 'inventariable', 'id_unidad', 'id_categoria', 'activo','fechavencimiento'];
