<div id="layoutSidenav_content" style="background: rgb(127, 140, 141)">
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6"> 
                        <br><img src="<?php echo base_url(); ?>/images/logotipo.png" class="img-responsive img-fluid rounded mx-auto d-block"><br>
                    </div><!--width="100" height="500"-->

                    <div class="col-12 col-sm-6" style="font-family: 'Coming Soon', cursive;">
            ...
            <div class="form-group" style="font-family: 'Coming Soon', cursive;">
                <div class="row">
                    <div class="col-12 col-sm-6" >
            ...
            <div class="form-group" style="font-family: 'Coming Soon', cursive;">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <br><p class="text-info " style="font-family: 'Rubik Bubbles', cursive;">Cargar Imagen   .PNG</p>
                    </div>       
                    <div class="col-12 col-sm-6">
                        <br>
